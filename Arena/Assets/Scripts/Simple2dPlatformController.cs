...
public class Simple2dPlatformController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Player Input
        var horizontalMovement = playerControls.InGame.Horizontal.ReadValue<float>();
        var verticalMovement = playerControls.InGame.Vertical.ReadValue<float>();
    ...
    private bool GetCanJump()
    {
        ...
        var jumpValue = playerControls.InGame.Jump.ReadValue<float>();
        bool jumpButtonDown;
